...
void MainFrame::InitButton()
{
   ...
   InitHisto(&Histo, Dcfg.RecordLength, N_CH);
	...
	ret = CAEN_DGTZ_WriteRegister(handle, 0x800C, 0xA); // 0x2 - 2 (lowest value); 0xA - 1024 (highest value)
	ret = CAEN_DGTZ_ReadRegister(handle, 0x800C, &reg_data);
	...
	ret = CAEN_DGTZ_WriteRegister(handle, 0x8034, 0x2); // 0x3FF - 1024 - dec (highest value)  0x10 - for kinetic meaurements
	ret = CAEN_DGTZ_ReadRegister(handle, 0x8034, &reg_data);
	printf(" Now in  0x%04X: %08X \n", 0x8034, reg_data);
    ...
    case M_LOAD_CONFIG:
         {
			...
			ctree->SetBranchAddress("AcqMode", &Dcfg.AcqMode);
			ctree->SetBranchAddress("IOlev", &Dcfg.IOlev);
			ctree->SetBranchAddress("EventAggr", &Dcfg.EventAggr);
			
			ctree->SetBranchAddress("ChannelMask", &Dcfg.ChannelMask);
			ctree->SetBranchAddress("InputRange", &Dcfg.InputRange);
			ctree->SetBranchAddress("PulsePolarity", Dcfg.PulsePolarity);
			ctree->SetBranchAddress("RecordLength", Dcfg.RecordLength);
			ctree->SetBranchAddress("PreTrigger", Dcfg.PreTrigger);
			ctree->SetBranchAddress("DCOffset", Dcfg.DCOffset);
			ctree->SetBranchAddress("thr", Dcfg.thr);
			ctree->SetBranchAddress("nsbl", Dcfg.nsbl);
			ctree->SetBranchAddress("lgate", Dcfg.lgate);
			ctree->SetBranchAddress("sgate", Dcfg.sgate);
			ctree->SetBranchAddress("pgate", Dcfg.pgate);
			ctree->SetBranchAddress("selft", Dcfg.selft);
			ctree->SetBranchAddress("discr", Dcfg.discr);
			ctree->SetBranchAddress("cfdd", Dcfg.cfdd);
			ctree->SetBranchAddress("cfdf", Dcfg.cfdf);
			ctree->SetBranchAddress("tvaw", Dcfg.tvaw);
			ctree->SetBranchAddress("csens", Dcfg.csens);
	...
	case M_SAVE_CONFIG:
         {
			...
			ctree->Branch("AcqMode", &Dcfg.AcqMode, "AcqMode/I");
			ctree->Branch("IOlev", &Dcfg.IOlev, "IOlev/I");
			ctree->Branch("EventAggr", &Dcfg.EventAggr);

			ctree->Branch("ChannelMask", &Dcfg.ChannelMask);
			ctree->Branch("InputRange", &Dcfg.InputRange, "InputRange[16]/I"); // not shure
			ctree->Branch("PulsePolarity", &Dcfg.PulsePolarity, "PulsePolarity[16]/I");
			ctree->Branch("RecordLength", &Dcfg.RecordLength, "RecordLength[16]/I");
			ctree->Branch("PreTrigger", &Dcfg.PreTrigger, "PreTrigger[16]/I");
			ctree->Branch("DCOffset", &Dcfg.DCOffset, "DCOffset[16]/I"); //, 
			ctree->Branch("thr", &Dcfg.thr, "thr[16]/I");
			ctree->Branch("nsbl", &Dcfg.nsbl, "nsbl[16]/I"); // not necessary property
			ctree->Branch("lgate", &Dcfg.lgate, "lgate[16]/I");
			ctree->Branch("sgate", &Dcfg.sgate, "sgate[16]/I");
			ctree->Branch("pgate", &Dcfg.pgate, "pgate[16]/I");	
			ctree->Branch("selft", &Dcfg.selft, "selft[16]/I");	
			ctree->Branch("discr", &Dcfg.discr, "discr[16]/I");	
			ctree->Branch("cfdd", &Dcfg.cfdd, "cfdd[16]/I");	
			ctree->Branch("cfdf", &Dcfg.cfdf, "cfdf[16]/I");	
			ctree->Branch("tvaw", &Dcfg.tvaw, "tvaw[16]/I");	
			ctree->Branch("csens", &Dcfg.csens, "csens[16]/I");	
