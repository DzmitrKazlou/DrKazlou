...
void OptMenu::DoSetVal()
{
	...
	Histo.trace[Histo.FirstToDraw]->GetXaxis()->SetRangeUser(Histo.WF_XMIN, Histo.WF_XMAX);
	Histo.trace[Histo.FirstToDraw]->GetXaxis()->SetTitle(" Time, ns");
	Histo.trace[Histo.FirstToDraw]->GetYaxis()->SetRangeUser(Histo.WF_YMIN, Histo.WF_YMAX);
	Histo.trace[Histo.FirstToDraw]->GetYaxis()->SetTitleOffset(1.1);
	Histo.trace[Histo.FirstToDraw]->GetYaxis()->SetTitle(" Channels, lbs"); 
}
